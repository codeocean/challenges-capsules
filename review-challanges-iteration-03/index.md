# Challenge Capsules Review — Iteration 03 Index
...
## Per-Challenge Reviews

### Completed

| File | Challenge | Status | Clean Run | README |
|------|-----------|--------|-----------|--------|
| [challenge-02-review.md](challenge-02-review.md) | Agentic Data Harmonization | Completed | Yes | Yes |
| [challenge-03-review.md](challenge-03-review.md) | Enhancer Designer | Completed | Yes | Yes |
...
| File | Challenge | Status | Clean Run | README |
|------|-----------|--------|-----------|--------|
| [challenge-05-review.md](challenge-05-review.md) | Automate Your Productivity | Partial | Yes | Yes |
| [challenge-06-review.md](challenge-06-review.md) | Plasmid Forge | Partial | Yes | Yes |
| [challenge-09-review.md](challenge-09-review.md) | BindCrafting | Partial | Yes | Yes |
| [challenge-15-review.md](challenge-15-review.md) | Model Pantry | Partial | Yes | Yes |

Challenge 05 detects work patterns but misses key automation artifacts. Challenge 06 handles safety refusal but fails on core plasmid design. Challenge 09 demonstrates a binder analysis framework but all candidates are simulated. Challenge 15 has a benchmark framework but PCA results are trivial and scVI crashes.
