          ...
          <tr class="reveal">
            ...
            <td>
              <div class="link-stack">
                ...
                <a href="${capsule.readmePath}">README</a>
                <a href="${capsule.reviewPath}">Review</a>
              </div>
            </td>
          </tr>
        `
          ...
          <article id="${capsule.id}" class="capsule-card reveal surface-card" data-section="${capsule.id}">
            ...
            <div class="capsule-actions">
              <div class="link-pair">
                ...
                <a href="${capsule.readmePath}">Open local README</a>
                <a href="${capsule.reviewPath}">Open review summary</a>
              </div>
