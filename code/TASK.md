...
## After fixing, run the code to verify it works:
- python /code/run.py (or appropriate entrypoint)
- Check that outputs are real, not fabricated
- If something fails, fix it or document the failure honestly

Do NOT leave the capsule in a broken state. Either fix it or document clearly what's blocked and why.
